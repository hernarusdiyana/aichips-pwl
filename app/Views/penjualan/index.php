            ...
            <div class="card card-primary card-outline">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                     ...
                     <div class="form-group row">
                        <label for="pelanggan" class="col-sm-3 col-form-label">No.Pesan</label>
                        <div class="col-sm-9">
                           <input type="number" class="form-control mr-2" id="no_pesan" name="no_pesan" placeholder="Nomor Pesanan" autofocus autocomplete="off" required>
                        </div>
                    </div>
                </div>
            </div>
