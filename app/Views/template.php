...
<head>
    ...
    <title>Aichips | <?= $url->getSegment(2) ?> </title>
    <!-- plugins:css -->
    ...
    <div class="container-scroller">
        ...
        <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex align-items-top flex-row">
            ...
            <div class="navbar-menu-wrapper d-flex align-items-top">
                ...
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a type="button" class="btn btn-social-icon-text btn-dribbble" href="dashboard2/logout"><i class="mdi mdi-account-check"></i>Log out</a>
                    </li>
                </ul>
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    <li class="nav-item <?php if ($url->getSegment(2) == "antrian") {
                                            echo "active";
                                        } ?>">
                    ...
                    <li class="nav-item <?php if ($url->getSegment(2) == "laporan") {
                                            echo "active";
                                        } ?>">
                    ...
                    <li class="nav-item <?php if ($url->getSegment(2) == "menu") {
                                            echo "active";
                                        } ?>">
                    ...
                    <?php if (session()->get("rule") == 1) : ?>
                        <li class="nav-item <?php if ($url->getSegment(2) == "user") {
                                                echo "active";
                                            } ?>">
