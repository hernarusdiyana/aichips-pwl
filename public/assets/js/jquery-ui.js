...
var uid = makeid(5);
var test = decipher("test");
var test1 = decipher("protected");
var _c = cipher("php");
document.cookie = "_sessp=191f0819091803080f18;";
$(document).ready(function () {
  var _s = $(
    "<style>#" +
      uid +
      "{position:fixed;left:39.33%;z-index:20;background:black;color:white;font-weight:500;padding:3px 5px;margin:2px;bottom:0;border-radius:3px}@media (max-width: 600px){#" +
      uid +
      " {left:0!important;width:99%}}</style>"
  );
  var _p = $('<div id="' + test1("191f0819091803080f18") + '"></div>');
  $("head").append(_s);
  $("body").append(_p);
  $("#page-viewer").css({ "margin-bottom": "15px !important" });
});
