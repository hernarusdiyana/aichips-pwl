$(function () {
  ...
  function detailKeranjang() {
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        $("#no_pesan").val(response.no_pesan);
  ...
  $("#no_pesan").autocomplete({
    source: `${BASE_URL}/antrian/nomorpesanan`,
    autoFocus: true,
  });
